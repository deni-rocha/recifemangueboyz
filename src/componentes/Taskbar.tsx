  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 h-9 bg-linear-to-b from-[#3168d5] via-[#2456c4] to-[#1941a5] flex items-center px-0.5 z-[1000] shadow-[0_-1px_3px_rgba(0,0,0,0.3)]">
      <button
        ...
        className="bg-linear-to-b from-[#3C8F3C] via-[#3CB44B] to-[#1E6B2E] text-white font-sans font-bold text-xs px-3 py-1 rounded-r-xl flex items-center gap-2 hover:brightness-110 active:brightness-90 h-7 mr-1"
      >
      ...
      <div className="bg-[#3C6CC6] border border-black/30 rounded-sm h-6.5 px-2 sm:px-3 flex items-center gap-2 text-white font-sans text-xs sm:text-base min-w-0 sm:min-w-[160px] shadow-[inset_0_0_3px_rgba(0,0,0,0.3)]">
        <span>📝</span>
        <span className="truncate">home</span>
      </div>
      <div className="ml-auto h-full bg-linear-to-b from-[#1B56C5] via-[#0F3DA5] to-[#0A2D8A] flex items-center px-2 sm:px-2.5 text-white font-sans text-xs sm:text-base gap-2">
